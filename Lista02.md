...
Inicio
   ...
   Leia(num)
   quadrado <- num ^ 2
   Escreval("O quadrado é: ", quadrado)
Fimalgoritmo
...
Inicio
   ...
   Leia(num2)
   subtracao <- num2 - num1
   Escreval("O resultado da subtração (segundo - primeiro) é: ", subtracao)
Fimalgoritmo
...
Inicio
   ...
   Escreval("O resultado da multiplicação é: ", multiplicacao)
Fimalgoritmo
